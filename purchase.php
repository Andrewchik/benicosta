...
<body>
 ...
 <header id="header-purchase" class="fixed-top d-flex align-items-center">
  ...
  <section id="block-1">
      <div class="container">
          <div class="house-1__title text-center">
            <h2>ЛЮКСОВАЯ  ВИЛЛА</h2>
            <p>На продажу в Испании с оформлением золотой резиденции!</p>
          </div>
          <div class="house-1__block">
              <div class="house-1__left">
                  <div class="house-img"></div>
              </div>
              <div class="house-1__right">
